...
INSERT IGNORE INTO doctors (id, user_id, specialization, experience_years, room_number) VALUES
(1, 1, 'Cardiologist', 8, '101'),
(2, 2, 'Orthopedic', 6, '102'),
(3, 3, 'Dermatologist', 5, '103'),
(4, 4, 'Neurologist', 10, '104'),
(5, 5, 'Pediatrician', 7, '105'),
(6, 6, 'General Physician', 9, '106'),
(7, 7, 'Gynecologist', 11, '107'),
(8, 8, 'ENT Specialist', 4, '108'),
(9, 9, 'Psychiatrist', 6, '109'),
(10, 10, 'Ophthalmologist', 12, '110'),
(11, 11, 'Dentist', 5, '111'),
(12, 12, 'Urologist', 8, '112'),
(13, 13, 'Endocrinologist', 7, '113'),
(14, 14, 'Gastroenterologist', 13, '114'),
(15, 15, 'Pulmonologist', 6, '115');